      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><input type="text" name="hello_paisa_total" value="<?php echo $hello_paisa_total; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_order_status; ?></td>
            <td><select name="hello_paisa_order_status_id">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $easy_paisa_order_status_id) { ?>
          ...
          <tr>
            ...
            <td><select name="hello_paisa_geo_zone_id">
                <option value="0"><?php echo $text_all_zones; ?></option>
                <?php foreach ($geo_zones as $geo_zone) { ?>
                <?php if ($geo_zone['geo_zone_id'] == $easy_paisa_geo_zone_id) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="hello_paisa_sort_order" value="<?php echo $hello_paisa_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
